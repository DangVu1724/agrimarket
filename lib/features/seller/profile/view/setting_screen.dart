...
class SettingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('Cài đặt'), centerTitle: true, backgroundColor: Colors.white),
      body: Padding(
        padding: const EdgeInsets.all(16.0),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [...sectionItems.map((item) => _buildSectionButton(item['icon'], item['title']))],
        ),
      ),
    );
  }
          ...
          children: [
            Row(
              children: [
                ...
                SizedBox(width: 16),
                Text(title, style: AppTextStyles.body.copyWith(color: Colors.black, fontSize: 16)),
              ],
            ),
