                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          validator: (value) =>
                              value == null || value.isEmpty ? 'Vui lòng nhập tên cửa hàng' : null,
                        ),
                        const SizedBox(height: 16),
                        TextFormField(
                        ...
                        Wrap(
                          spacing: 8,
                          children: vm.availableCategories.map((category) {
                            return Obx(
                              () => FilterChip(
                                label: Text(category),
                                selected: vm.categories.contains(category),
                                onSelected: (selected) => vm.toggleCategory(category),
                              ),
                            );
                          }).toList(),
                        ),
                        ...
                        _buildCertificateSection(
                          ...
                          onPickGallery: () => vm.pickImage(isBusinessLicense: true),
                          onPickCamera: () => vm.pickImage(isBusinessLicense: true, fromCamera: true),
                        ...
                        _buildCertificateSection(
                          ...
                          onPickGallery: () => vm.pickImage(isBusinessLicense: false),
                          onPickCamera: () => vm.pickImage(isBusinessLicense: false, fromCamera: true),
