              ...
              child: Column(
                ...
                children: [
                    ...
                    onChanged: (value) {
                      if (value != null) {
                        ...
                        if (selectedProvince['name'] != '') {
                          vm.provinceController.text =
                              selectedProvince['name'] as String;
                          vm.selectedProvinceCode.value = value;
                          vm.districtController.clear();
                          vm.wardController.clear();
                          print(
                            'Selected province: ${vm.provinceController.text}, code: $value',
                          );
                        }
                      }
                    },
                  ...
                  CustomDropdownField<String>(
                    ...
                    hintText:
                        vm.provinces.isEmpty
                            ? 'Vui lòng chọn tỉnh/thành phố trước'
                            : null,
                    isLoading: vm.isLoadingDistrict.value,
                    onChanged: (value) {
                      if (value != null) {
                        ...
                        if (selectedDistrict['name'] != '') {
                          vm.districtController.text =
                              selectedDistrict['name'] as String;
                          vm.selectedDistrictCode.value = value;
                          vm.onDistrictChanged();
                          print(
                            'Selected district: ${vm.districtController.text}, code: $value',
                          );
                        }
                      }
                    },
                  ...
                  CustomDropdownField<String>(
                    labelText: 'Phường/Xã',
                    value:
                        vm.districts.isNotEmpty
                            ? vm.selectedWardCode.value
                            : null,
                    items: vm.wards,
                    isEnabled: vm.districts.isNotEmpty,
                    hintText:
                        vm.districts.isEmpty
                            ? 'Vui lòng chọn quận/huyện trước'
                            : null,
                    isLoading: vm.isLoadingWard.value,
                    onChanged: (value) {
                      if (value != null) {
                        ...
                        if (selectedWard['name'] != '') {
                          vm.wardController.text =
                              selectedWard['name'] as String;
                          vm.selectedWardCode.value = value;
                          vm.onWardChanged();
                          print(
                            'Selected ward: ${vm.wardController.text}, code: $value',
                          );
                        }
                      }
                    },
