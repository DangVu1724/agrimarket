...
class StoreProductList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      if (storeVm.storeData.value == null) {
        storeVm.fetchStoreByID(storeId);
      }

      final store = storeVm.storeData.value;
      final products = productController.products;

      if (productController.isLoading.value || storeVm.isLoading.value) {
        ...
        child: ListView.builder(
          ...
          itemBuilder: (_, index) {
            ...
            return FutureBuilder<ProductPromotionModel?>(
              future:
                  product.promotion != null ? storeDetailVm.getDiscountInfo(product.promotion!) : Future.value(null),
